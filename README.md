...
<l><li>static approach (Skip-gram with negative sampling model),</li>
  <li>dynamic approach (Dynamic word embeddings model) and </li> 
  <li>contextualized approach (BERT model).</li></l> <br>
